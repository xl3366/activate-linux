...
// English is default language, so it has to be first in the list
  {"en_US,en_GB", {"Activated ", "", "Go to Settings to deactivate ", "."},
  ...
  {"es_ES,es_AR,es_BO,es_CL,es_CO,es_CR,es_DO,es_EC,es_SV,es_GT,es_HN,es_NI,es_PA,es_PY,es_PE,es_PR,es_UY,es_VE", 
    {"Desactivar ", "", "Ve a Configuración para desactivar ", "."},
	{"No hay necesidad de activar ", "", "No somos tan molestos como Microsoft."}},
  {"de_DE", {"", " deaktivieren", "Wechseln Sie zu den Einstellungen, um ", " zu deaktivieren."},
	{"", " muss nicht aktiviert werden", "Wir sind nicht so lästig wie Microsoft."}},
  {"fr_CA", {"Désactivez ", "", "Accédez aux paramètres pour désactiver ", "."},
    {"Pas besoin d'activer ", "", "Nous ne sommes pas aussi gossants que Microsoft."}},
  {"fr_FR", {"Désactivez ", "", "Accédez aux paramètres pour désactiver ", "."},
	{"Pas besoin d'activer ", "", "Nous ne sommes pas aussi agaçants que Microsoft."}},
  {"it_IT", {"Disattivato ", "", "Vai su Impostazioni per disattivare ", "."},
    {NULL, NULL, NULL}},
  {"ja_JP", {"", "のライセンスを無効化", "設定を開き、", "のライセンスを無効化してください。"},
    {NULL, NULL, NULL}},
  {"nl_NL", {"Deactiveren ", "", "Ga naar Instellingen om te deactiveren ", "."},
    {NULL, NULL, NULL}},
  {"pl_PL", {"Dezaktywuj system ", "", "Przejdź do ustawień, aby dezaktywować system ", "."},
	{"Nie trzeba aktywować systemu ", "", "Nie jesteśmy tak denerwujący jak Microsoft."}},
  {"pt_BR", {"Desativar o ", "", "Acesse Configurações para desativar o ", "."},
	{"Não precisa ativar o ", "", "Não somos tão irritantes como a Microsoft."}},
  {"ru_RU", {"Деактивация ", "", "Для отключения ", ",\nперейдите в раздел \"Параметры\"."},
	{"Активировать ", " не надо", "Мы не так назойливы, как Microsoft."}},
  {"tr_TR", {"", "'u Devre Dışı Bırak", "", "'u devre dışı bırakmak için Ayarlar'a gidin."},
	{"", "'u etkinleştirmeye gerek yok", "Microsoft kadar gıcık değiliz."}},
  {"zh_CN", {"已激活", "", "转到“设置”以取消激活", "。"},
    {"无需激活", "", "我们不像 Microsoft 那样烦人。"}},
  {"zh_TW", {"已激活", "", "移至[設定]以取消激活", "。"},
    {"無需激活", "", "我們不像 Microsoft 那樣煩人。"}},
  {"zh_HK", {"已激活", "", "移至[設定]以取消激活", "。"},
    {"無需激活", "", "我們不像 Microsoft 那樣煩人。"}},
};
